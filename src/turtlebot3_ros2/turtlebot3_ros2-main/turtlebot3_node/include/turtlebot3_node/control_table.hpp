...
typedef struct
{
  ...
  ControlItem robit_mode_led  = {400, RAM, 1, READ_WRITE};
  ControlItem robit_button    = {401, RAM, 1, READ};
  ControlItem robit_psd_l     = {402, RAM, 2, READ};
  ControlItem robit_psd_f     = {404, RAM, 2, READ};
  ControlItem robit_psd_r     = {406, RAM, 2, READ};
} ControlTable;
